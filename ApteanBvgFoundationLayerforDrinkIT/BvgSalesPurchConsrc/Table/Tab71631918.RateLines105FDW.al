table 71631918 RateLines105FDW
{
  Caption = 'Condition Rate';

  fields
  {
    field(1; ConditionRuleNo; Integer)
    {
    ...
    field(12; UnitofMeasureCodeQty; Code[10])
    {
    ...
    field(21; PricesIncludingVAT; Boolean)
    {
  ...
  keys
  {
    key(Key1; ConditionRuleNo, "Line No.")
    {
    }
    key(Key2; ConditionRuleNo, "Starting Date", "Ending Date", "Currency Code", "Item No.", UnitofMeasureCodeQty, "Unit of Measure Code (Price)", "Minimum Quantity", "Maximum Quantity", "Minimum Amount", "Maximum Amount")
    {
    }
    key(Key3; ConditionRuleNo, "Free Unit of Measure Code")
    {
    }
    key(Key4; ConditionRuleNo, "Unit of Measure Code (Price)")
    {
    }
    key(Key5; ConditionRuleNo, "Free Item Type")
    {
    }
    key(Key6; ConditionRuleNo, "Currency Code", "Item No.", "Starting Date", "Ending Date")
    {
    }
  }
  fieldgroups
