table 71631887 DocumentLine105FDW
{
  ...
  fields
  {
    ...
    field(99; "Document Status"; Enum SalesPurchDocStatus105FDW)
    {
    ...
    field(900; "Amount Including VAT"; Decimal)
    {
      Caption = 'Amount Including VAT';
    }
    field(901; "Amount Including VAT (LCY)"; Decimal)
    {
    ...
    field(5005; "Periodic Journal Doc. No."; Code[20])
    {
      Caption = 'Periodic Journal Document No.';
    }
    field(5006; "Periodic Posted"; Boolean)
    {
      Caption = 'Periodic Posted';
    }
    field(5007; "Periodic Cond. Doc. Line No."; Integer)
    {
      Caption = 'Periodic Condition Doc. Line No.';
    }
  ...
  keys
  {
    ...
    key(SKey_RuleId; "Rule No.", "Rate ID", "Source Condition No. (Filter)", "Document Status", Type, "No.", "Unit of Measure Code")
    {
    }
    key(SKey_RuleOrdered; "Source Type", "Document Type", "Document Status", "Rule No.")
    {
    }
    key(SKey_PostingApplyEntry; "Posting Date", "Applies-to Condition Entry No.", "Applies-to Item Entry No.")
    {
    }
    key(SKey_PeriodicLink; "Periodic Source Type", "Periodic Source Subtype", "Periodic Source ID", "Periodic Source Batch Name", "Periodic Source Ref. No.", "Periodic Cond. Doc. Line No.")
    {
    }
  }
