table 70238229 SalesDocTradeLineArchiveFDW
{
  Caption = 'Sales Document Trade Line Archive';
  ...
  keys
  {
    key(PK; "Document Table ID", "Document Type", "Document No.", "Doc. No. Occurrence", "Version No.", "Document Line No.", "Trade Plan No.")
    {
    }
