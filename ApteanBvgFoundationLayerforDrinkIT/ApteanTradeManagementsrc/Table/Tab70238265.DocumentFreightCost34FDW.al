table 70238265 "Document Freight Cost34FDW"
{
  Caption = 'Document Freight Cost';
  ...
  fields
  {
    ...
    field(40; "Freight Cost Posted"; Boolean)
    {
      Caption = 'Freight Cost Posted';
    }
  }
  keys
  {
  ...
  var 
  // DeleteFreightCostWhenPostedErr: Label[100];
  // InsertFreightCostWhenPostedErr: Label[150];
}