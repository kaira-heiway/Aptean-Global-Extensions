table 70238243 DocumentTradeLine34FDW
{
  Caption = 'Document Trade Line';
  ...
  fields
  {
    ...
    field(85; "Pstd Doc. Trade Table ID"; Integer)
    {
      Caption = 'Posted Doc. Trade Table ID';
    }
    field(86; "Pstd Doc. Trade Doc. Type"; Integer)
    {
      Caption = 'Posted Doc. Trade Document Type';
    }
    field(87; "Pstd Doc. Trade Doc. No."; Code[20])
    {
      Caption = 'Posted Doc. Trade Document No.';
    }
    field(88; "Pstd Doc. Trade Doc. Line No."; Integer)
    {
      Caption = 'Posted Doc. Trade Line No.';
    }
    field(89; "Pstd Doc. Trade DTL No."; Integer)
    {
      Caption = 'Posted Doc. Trade DTL No.';
    }
    field(90; "Zeroed Out"; Boolean)
    {
      Caption = 'Zeroed Out';
    }
  }
  ...
  fieldgroups
  {
    fieldgroup(Brick; "Price Rule", "Accrual Type", "Trade Plan No.", "Rate Type", "Eligible Base", Amount)
    {
    }
  }
 // var SalesPriceFrozenErr: Label[250];
}