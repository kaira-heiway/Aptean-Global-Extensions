table 71423180 PostedQCCheckHeader92FDW
{
  Caption = 'Posted Quality Control Check Header';
  ...
  fields
  {
    ...
    field(33; "QC Check No. Series"; Code[20])
    {
      Caption = 'Quality Check No. Series';
    }
    field(34; "QC Check No."; Code[20])
    {
    ...
    field(54; "New QC On Failure"; Code[20])
    {
      Caption = 'New QC Check On Failure';
    }
