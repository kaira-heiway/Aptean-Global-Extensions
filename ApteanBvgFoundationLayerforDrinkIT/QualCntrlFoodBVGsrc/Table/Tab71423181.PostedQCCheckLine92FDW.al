table 71423181 PostedQCCheckLine92FDW
{
  Caption = 'Posted Quality Control Check Line';
  ...
  keys
  {
    ...
    key(Key3; "Failure Action Plan")
    {
    }
    key(Key4; "QC Question Code")
    {
    }
    key(Key5; "Answer Decimal")
    {
    }
    key(Key6; "Answer Integer")
    {
    }
  }
}