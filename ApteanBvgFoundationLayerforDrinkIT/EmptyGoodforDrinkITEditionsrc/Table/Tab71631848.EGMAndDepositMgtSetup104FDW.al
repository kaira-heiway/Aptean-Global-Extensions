table 71631848 EGMAndDepositMgtSetup104FDW
{
  ...
  fields
  {
    ...
    field(9; "Show Variant Code"; Boolean)
    {
      Caption = 'Show Variant Code';
    }
    field(10; "Show zero Qty. S. Inv/Cr.Memo"; Boolean)
    {
      Caption = 'Show zero Quantity Sales Invoice/Cr.Memo lines';
    }
    field(11; "Show zero Qty. P. Inv/Cr.Memo"; Boolean)
    {
      Caption = 'Show zero Quantity Purchase Invoice/Cr.Memo lines';
    }
  }
  keys
  {
